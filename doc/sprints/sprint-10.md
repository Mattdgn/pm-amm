...
### Deploy
- [ ] Creer `anchor/scripts/deploy-devnet.ts` : build + deploy sur devnet avec keypair
- [ ] Verifier programme deploye et accessible

### Seed data
- [ ] Creer `anchor/scripts/seed-devnet.ts` :
...
- [ ] Creer `anchor/scripts/simulate-life.ts` :
  - Simule 7 jours compresses : warps + trades aleatoires + accruals
  - Genere de l'historique pour le front
- [ ] Creer `anchor/scripts/airdrop.ts` : airdrop SOL devnet aux wallets de test

### Verification
- [ ] Markets seed visibles on-chain
- [ ] Accrual fonctionne sur les markets seed
- [ ] Programme ID documente dans `anchor/Anchor.toml` et README
